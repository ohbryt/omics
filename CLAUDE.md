...
These rules are binding for any agent (Claude Code / CLI) working in this repository. The goal is **deterministic, reproducible, auditable** omics analysis. The agent **orchestrates and writes code; it does not compute or judge data in its head.**
